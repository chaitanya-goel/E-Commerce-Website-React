...
import { addToCart, getProductsByCategory, getAllProducts } from "../API"
import { Badge, Button, Card, Image, List, message, Rate, Select, Typography } from "antd";
                ...
                renderItem={(product, index) => {
                    return (
                        ...
                        <Badge.Ribbon className="itemCardBadge" text={`${product.discountPercentage}% Off`} color="pink">
                            ...
                            <Card className="itemCard" title={product.title}
                                key={index}
...
function AddtoCartButton({ item }) {
    ...
    return <Button className="add-to-cart-button" type="link" onClick={() => {
        addProducttoCart();
    }}
